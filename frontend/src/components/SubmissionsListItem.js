...
const SubmissionsListItem = (props)=>{
    ...
    {<IconButton  aria-label="delete" onClick={async (e)=>{await props.dispatch(deleteSubmission(props.room_id,props.submission._id,props.submission))}}><Delete  fontSize="large" /></IconButton>}
    </div>
    </AccordionSummary>
    <AccordionDetails>
    {
    ...
    {<IconButton  style={{position:"absolute",right:0}} aria-label="delete" onClick={async (e)=>{await props.dispatch(deleteSubmission(props.room_id,props.submission._id,props.submission))}}><Delete  fontSize="large" /></IconButton>}
    </div>
